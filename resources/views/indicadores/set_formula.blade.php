            ...
            <input class="form-control" type="hidden" id="descripcion" name="descripcion" placeholder="Descripción"
                value="{{ $indicador['descripcion'] ?? '' }}">
            <input class="form-control" type="hidden" id="unidad_medida" name="unidad_medida"
                value="{{ $indicador['unidad_medida'] ?? '' }}">
            ...
            <div class="mt-2">
                ...
                @if ($indicador && $indicador['indicador_confirmado'])
                    ...
                    <textarea rows="5" disabled class="form-control metodo_calculo disabled" id="metodo_calculo" name="metodo_calculo"
                        placeholder="Método de Cálculo">{{ $indicador['metodo_calculo'] ?? '' }}</textarea>
                @else
                    <textarea rows="5" class="form-control metodo_calculo editable" id="metodo_calculo" name="metodo_calculo"
                        placeholder="Método de Cálculo">{{ $indicador['metodo_calculo'] ?? '' }}</textarea>
                @endif
                <h6 class="mt-2">Ejemplo</h6>
                <p>
                    <span class="font-bold text-blue-500">(</span><span class="text-pink-900">Expedientes de contratos
                        de arrendamiento devueltos con observaciones</span> <span
                        class="font-bold text-blue-500">/</span> <span class="text-pink-900">Expedientes para generar
                        contratos de arrendamiento</span><span class="text-blue-500 font-bold">)</span> <span
                        class="text-blue-500 font-bold">*</span> <span class="text-pink-900">100</span>
                </p>
            </div>
            <div class="mt-2">
